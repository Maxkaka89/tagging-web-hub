...
import { Lock, Mail, User, ArrowRight, ShieldCheck, CheckCircle2, AlertCircle, Eye, EyeOff, KeyRound, ArrowLeft } from "lucide-react"
...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 relative overflow-hidden">
            {/* Background Effects */}
            <div className={`absolute top-[-20%] left-[-10%] w-[50%] h-[50%] blur-[120px] rounded-full pointer-events-none transition-colors duration-1000 ${step === 'form' ? 'bg-emerald-600/20' : 'bg-amber-500/20'}`} />
                    ...
                    {step === "form" ? (
                        <div className="animate-in fade-in slide-in-from-left-4 duration-500">
                            <div className="text-center mb-8">
                                ...
                                <p className="text-slate-400">Join the Concentrix Web Hub</p>
                            </div>
                            ...
                            <p className="text-center text-slate-500 text-xl mt-8">
                                Already have an account? <a href="/login" className="text-indigo-400 hover:text-indigo-300 font-semibold">Log in</a>
                            </p>
                        </div>
                    ) : (
                        <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            <p className="text-center text-slate-500 text-sm mt-8">
                                ...
                                <button onClick={handleSignUp} disabled={isLoading} className="text-amber-400 hover:text-amber-300 font-medium disabled:opacity-50">
                                    Resend Code
                                </button>
                            </p>
                        </div>
